                        ...
                        <div class="card-columns">
                            ...
                            <div class="card text-center" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p> &#2547 <%= product.getPriceAfterApplyingDiscount()%>/-  <strong><%=product.getpDiscount()%>% off</strong></p>
                                    <a href="#" class="btn btn-primary" onclick="add_to_cart(<%= product.getpId()%>, '<%= product.getpName()%>', <%= product.getPriceAfterApplyingDiscount()%>)">Add to Cart</a>
                                </div>
                            </div>
